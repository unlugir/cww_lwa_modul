...
words_15 = {
    'x': (0, 10.01, 0.01),
    'words': {
        'Extremely Poor': {'umf': ('trapmf', 0, 0, 0.22, 3.16), 'lmf': ('trapmf', 0, 0, 0.02, 0.33, 1)},
        'Poor': {'umf': ('trapmf', 0, 0, 0.46, 2.63), 'lmf': ('trapmf', 0, 0, 0.06, 0.92, 1)},
        'Moderately Poor': {'umf': ('trapmf', 0, 0, 1.37, 3.95), 'lmf': ('trapmf', 0, 0, 0.14, 1.82, 1)},
        'Slightly Poor': {'umf': ('trapmf', 0.38, 1.63, 3.00, 4.62), 'lmf': ('trapmf', 1.90, 2.24, 2.24, 2.51, 0.31)},
        'Adequate': {'umf': ('trapmf', 0.38, 2.25, 4.00, 5.92), 'lmf': ('trapmf', 2.99, 3.31, 3.31, 3.81, 0.32)},
        'Somewhat reasonable': {'umf': ('trapmf', 0.98, 2.75, 4.00, 5.46), 'lmf': ('trapmf', 2.79, 3.30, 3.30, 3.71, 0.42)},
        'Reasonable': {'umf': ('trapmf', 0.38, 2.50, 4.50, 6.62), 'lmf': ('trapmf', 2.95, 3.18, 3.18, 3.30, 0.15)},
        'Fair': {'umf': ('trapmf', 0.17, 2.73, 4.80, 7.91), 'lmf': ('trapmf', 3.29, 3.75, 3.75, 4.21, 0.31)},
        'Somewhat fair': {'umf': ('trapmf', 2.33, 5.11, 7.00, 9.59), 'lmf': ('trapmf', 5.79, 6.31, 6.31, 7.21, 0.43)},
        'Very fair': {'umf': ('trapmf', 4.38, 6.25, 8.00, 9.62), 'lmf': ('trapmf', 6.90, 7.21, 7.21, 7.60, 0.29)},
        'Moderately Good': {'umf': ('trapmf', 4.48, 6.25, 8.15, 9.52), 'lmf': ('trapmf', 6.81, 7.27, 7.27, 7.81, 0.35)},
        'Good': {'umf': ('trapmf', 5.59, 6.75, 8.00, 9.56), 'lmf': ('trapmf', 6.79, 7.30, 7.30, 7.71, 0.42)},
        'Very good': {'umf': ('trapmf', 4.73, 8.82, 10, 10), 'lmf': ('trapmf', 7.68, 9.82, 10, 10, 1)},
        'Excellent': {'umf': ('trapmf', 6.05, 9.36, 10, 10), 'lmf': ('trapmf', 8.71, 9.91, 10, 10, 1)},
        'Outstanding': {'umf': ('trapmf', 7.10, 9.80, 10, 10), 'lmf': ('trapmf', 9.74, 9.98, 10, 10, 1)},
    }
}
...
words_11 = {
    'x': (0, 10.01, 0.01),
    'words': {
        'Extremely Poor': {'umf': ('trapmf', 0, 0, 0.59, 3.95), 'lmf': ('trapmf', 0, 0, 0.09, 1.32, 1)},
        'Poor': {'umf': ('trapmf', 0.28, 2.00, 3.00, 5.22), 'lmf': ('trapmf', 1.79, 2.37, 2.37, 2.71, 0.48)},
        'Moderately Poor': {'umf': ('trapmf', 0.98, 2.40, 4.00, 5.41), 'lmf': ('trapmf', 2.79, 3.22, 3.22, 3.67, 0.35)},
        'Slightly Poor': {'umf': ('trapmf', 0.98, 2.75, 4.00, 5.41), 'lmf': ('trapmf', 2.79, 3.30, 3.30, 3.71, 0.42)},
        'Adequate': {'umf': ('trapmf', 2.38, 4.50, 6.00, 8.18), 'lmf': ('trapmf', 4.79, 5.12, 5.12, 5.35, 0.27)},
        'Reasonable': {'umf': ('trapmf', 2.38, 4.50, 6.50, 8.62), 'lmf': ('trapmf', 4.79, 5.33, 5.33, 5.71, 0.31)},
        'Fair': {'umf': ('trapmf', 2.38, 4.50, 6.50, 8.62), 'lmf': ('trapmf', 5.19, 5.63, 5.63, 6.21, 0.34)},
        'Slightly Good': {'umf': ('trapmf', 4.02, 5.65, 7.00, 8.41), 'lmf': ('trapmf', 5.89, 6.34, 6.34, 6.81, 0.40)},
        'Moderately Good': {'umf': ('trapmf', 4.38, 6.00, 7.50, 9.62), 'lmf': ('trapmf', 6.23, 6.73, 6.73, 7.21, 0.39)},
